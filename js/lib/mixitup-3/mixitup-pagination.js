...
(function(window) {
    ...
    var mixitupPagination = function(mixitup) {
        ...
        mixitup.ConfigTemplates.registerAction('afterConstruct', 'pagination', function() {
            ...
            this.pagerPrev = '<button type="button" class="${classNames}" data-page="prev">&lt;</button>'; //上一頁箭頭
            ...
            this.pagerNext = '<button type="button" class="${classNames}" data-page="next">&gt;</button>'; //下一頁箭頭
